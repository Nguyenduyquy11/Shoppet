...
class DonHangController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admins.donhang.index', compact('title','listDonHang','trangThaiDonHang','type_huy_don_hang'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admins.donhang.show', compact('title','donHang','trangThaiDonHang','trangThaiThanhToan'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        //Kiểm tra nếu đơn hang đã bị hủy thì không được thay đổi trạng thái
        if ($currentTrangThai === DonHang::HUY_DON_HANG) {
            return redirect()->route('admin.donhang.index')->with('error', 'Đơn hàng đã bị hủy không thể thay đổi trạng thái');
        }
        //Kiểm tra nếu trạng mới không được nằm sau trạng thái hiện tại
    ...
    {
        // Khi người dùng hủy đơn hàng thì mới được xóa
        $donHang = DonHang::query()->findOrFail($id);
