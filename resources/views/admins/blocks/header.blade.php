<div class="wrapper">
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__wobble" src="{{ asset('assets/admins/img/AdminLTELogo.png') }}" alt="AdminLTELogo" height="60" width="60">
    </div>
    ...
    <br><h2 class="title-manage pd">Quản Lí Thú Cưng</h2>
    <hr>
